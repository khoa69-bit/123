...
?>
    ...
    if (isset($_POST['btDathang'])) {
        ...
        foreach($cart as $item){
            ...
            $sqli = "INSERT INTO order_detail values (0, $last_order_id, $masp, $disscounted_price, $qty, $total, now(), now())";
            mysqli_query($conn, $sqli2);
        }
        unset($_SESSION["cart"]);
        header("location: thankyou.php?id=");
    }
                            ...
                            <div class="checkout__order">
                                ...
                                <?php
                                    ...
                                    foreach ($cart as $item) {
                                        $total += $item['qty'] * $item['disscounted_price'];
                                        ?>
                                        <li><?=$item['name']?><span><?= number_format(($item['disscounted_price'] * $item['qty']), 0, '', '.') . " VNĐ" ?></span></li>
