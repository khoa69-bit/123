    ...
    <section class="product spad">
        ...
        <a href="sanpham.php?id=<?=$row['id']?>" class="latest-product__item">
            ...
            <div class="latest-product__item__text">
                ...
                <span><?php echo $row['disscounted_price'];?></span>
            </div>
        </a>
        <?php 
        }
                    ...
                    <div class="product__discount">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                <?php 
                                $sql_str = "SELECT products.id as pid, products.name as pname, categories.name as cname, round((price - disscounted_price)/price*100) 
                                as discount, images, price, disscounted_price FROM products, categories where products.category_id=categories.id ORDER BY discount limit 0, 6; ";
                                $result = mysqli_query($conn, $sql_str);
                                while ($row = mysqli_fetch_assoc($result)){
                                    $anh_arr = explode(";", $row["images"]);
                                ?>
